...
class ProcessingStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetNextPass = channel.unary_unary(
                '/pointing.Processing/GetNextPass',
                request_serializer=pointing__pb2.NextPassRequest.SerializeToString,
                response_deserializer=pointing__pb2.NextPassReply.FromString,
                )
        self.GetSchedule = channel.unary_unary(
                '/pointing.Processing/GetSchedule',
                request_serializer=pointing__pb2.ScheduleRequest.SerializeToString,
                response_deserializer=pointing__pb2.ScheduleReply.FromString,
                )
...
def add_ProcessingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetNextPass': grpc.unary_unary_rpc_method_handler(
                    servicer.GetNextPass,
                    request_deserializer=pointing__pb2.NextPassRequest.FromString,
                    response_serializer=pointing__pb2.NextPassReply.SerializeToString,
            ),
            'GetSchedule': grpc.unary_unary_rpc_method_handler(
                    servicer.GetSchedule,
                    request_deserializer=pointing__pb2.ScheduleRequest.FromString,
                    response_serializer=pointing__pb2.ScheduleReply.SerializeToString,
            ),
    }
...
class Processing(object):
    ...
    def GetNextPass(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pointing.Processing/GetNextPass',
            pointing__pb2.NextPassRequest.SerializeToString,
            pointing__pb2.NextPassReply.FromString,
    ...
    def GetSchedule(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pointing.Processing/GetSchedule',
            pointing__pb2.ScheduleRequest.SerializeToString,
            pointing__pb2.ScheduleReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
