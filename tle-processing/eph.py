...
def get_range(satellite_name, tle_line_1, tle_line_2,
...
def get_pointing_range_list(satellite_name, tle_line_1, tle_line_2,
                            station_latitude, station_longitude, station_altitude,
    ...
    for i in range(number_of_entries):
        ...
        azimuth, elevation, range_meter = get_range(satellite_name, tle_line_1, tle_line_2,
                                                    station_latitude, station_longitude, station_altitude,
                                                    current_date_string)
