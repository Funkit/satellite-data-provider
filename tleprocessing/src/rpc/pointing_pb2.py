...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b'\n\x1efunkit.satellite-data-providerB\x14AntennaPointingProtoP\x01Z2github.com/Funkit/satellite-data-provider/sattrack'
