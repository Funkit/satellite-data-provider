...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x0epointing.proto\x12\x08pointing\x1a\x0e\x64\x61tetime.proto\"L\n\x14SatelliteInformation\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x12\n\ntle_line_1\x18\x02 \x01(\t\x12\x12\n\ntle_line_2\x18\x03 \x01(\t\"\xa1\x01\n\x18GroundStationInformation\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x10\n\x08latitude\x18\x02 \x01(\x01\x12\x11\n\tlongitude\x18\x03 \x01(\x01\x12\x10\n\x08\x61ltitude\x18\x04 \x01(\x01\x12\x19\n\x11minimum_elevation\x18\x05 \x01(\x01\x12%\n\x1dstation_positioning_delay_sec\x18\x06 \x01(\x05\"\xc8\x01\n\x0fNextPassRequest\x12#\n\tsatellite\x18\x01 \x01(\x0b\x32\x10.pointing.SatMon\x12;\n\x0fground_stations\x18\x02 \x03(\x0b\x32\".pointing.GroundStationInformation\x12)\n\nstart_date\x18\x03 \x01(\x0b\x32\x15.google.type.DateTime\x12(\n\tstop_date\x18\x04 \x01(\x0b\x32\x15.google.type.DateTime\"n\n\rNextPassReply\x12\x16\n\x0esatellite_name\x18\x01 \x01(\t\x12\x14\n\x0cstation_name\x18\x02 \x01(\t\x12/\n\x08pointing\x18\x03 \x03(\x0b\x32\x1d.pointing.PointingInformation\"z\n\x13PointingInformation\x12#\n\x04\x64\x61te\x18\x01 \x01(\x0b\x32\x15.google.type.DateTime\x12\x0f\n\x07\x61zimuth\x18\x02 \x01(\x01\x12\x11\n\televation\x18\x03 \x01(\x01\x12\x14\n\x0crange_meters\x18\x05 \x01(\x01J\x04\x08\x04\x10\x05\"\xd4\x01\n\x0fScheduleRequest\x12$\n\nsatellites\x18\x01 \x03(\x0b\x32\x10.pointing.SatMon\x12\x46\n\x1aground_station_information\x18\x03 \x03(\x0b\x32\".pointing.GroundStationInformation\x12)\n\nstart_date\x18\x04 \x01(\x0b\x32\x15.google.type.DateTime\x12(\n\tstop_date\x18\x05 \x01(\x0b\x32\x15.google.type.DateTime\"h\n\x06SatMon\x12=\n\x15satellite_information\x18\x01 \x01(\x0b\x32\x1e.pointing.SatelliteInformation\x12\x1f\n\x17minimum_pass_length_sec\x18\x02 \x01(\x05\"8\n\rScheduleReply\x12\'\n\x06passes\x18\x01 \x03(\x0b\x32\x17.pointing.NextPassReply2\x92\x01\n\nProcessing\x12\x41\n\x0bGetNextPass\x12\x19.pointing.NextPassRequest\x1a\x17.pointing.NextPassReply\x12\x41\n\x0bGetSchedule\x12\x19.pointing.ScheduleRequest\x1a\x17.pointing.ScheduleReplyBl\n\x1e\x66unkit.satellite-data-providerB\x14\x41ntennaPointingProtoP\x01Z2github.com/Funkit/satellite-data-provider/pointingb\x06proto3')
...
NextPassReply = _reflection.GeneratedProtocolMessageType('NextPassReply', (_message.Message,), {
  'DESCRIPTOR' : _NEXTPASSREPLY,
  '__module__' : 'pointing_pb2'
  # @@protoc_insertion_point(class_scope:pointing.NextPassReply)
  })
_sym_db.RegisterMessage(NextPassReply)

PointingInformation = _reflection.GeneratedProtocolMessageType('PointingInformation', (_message.Message,), {
  'DESCRIPTOR' : _POINTINGINFORMATION,
  '__module__' : 'pointing_pb2'
  # @@protoc_insertion_point(class_scope:pointing.PointingInformation)
  })
...
ScheduleRequest = _reflection.GeneratedProtocolMessageType('ScheduleRequest', (_message.Message,), {
  ...
  '__module__' : 'pointing_pb2'
  # @@protoc_insertion_point(class_scope:pointing.ScheduleRequest)
  })
_sym_db.RegisterMessage(ScheduleRequest)

SatMon = _reflection.GeneratedProtocolMessageType('SatMon', (_message.Message,), {
  'DESCRIPTOR' : _SATMON,
  '__module__' : 'pointing_pb2'
  # @@protoc_insertion_point(class_scope:pointing.SatMon)
  })
...
ScheduleReply = _reflection.GeneratedProtocolMessageType('ScheduleReply', (_message.Message,), {
  ...
  '__module__' : 'pointing_pb2'
  # @@protoc_insertion_point(class_scope:pointing.ScheduleReply)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SCHEDULEREQUEST._serialized_end=938
  _SATMON._serialized_start=940
  _SATMON._serialized_end=1044
  _SCHEDULEREPLY._serialized_start=1046
  _SCHEDULEREPLY._serialized_end=1102
  _PROCESSING._serialized_start=1105
  _PROCESSING._serialized_end=1251
